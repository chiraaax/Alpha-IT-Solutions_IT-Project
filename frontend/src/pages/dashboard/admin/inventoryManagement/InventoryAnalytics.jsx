...
export default function InventoryAnalytics() {
 ...
 const handleGenerateReport = async () => {
  ...
  doc.text("Inventory & Sales Report", 105, 110, { align: "center" });

  doc.setFontSize(14);
  doc.setTextColor(primaryColor);
  doc.text("Alpha IT Solutions", 105, 120, { align: "center" });

  doc.setFont("helvetica", "italic");
  doc.setFontSize(12);
  doc.setTextColor(secondaryColor);
  doc.text(`Generated on: ${new Date().toLocaleString()}`, 105, 130, { align: "center" });
  ...
  const addFooter = () => {
    ...
    doc.text("Generated by Alpha IT Solutions | Confidential", 10, 290, { align: "left" });
    pageCount++;
  };
  ...
  Object.entries(byCat).forEach(([category, prods], idx) => {
    ...
    const columns = ["_id", "Price", "Discount Price", "Stock", "State", "Availability"];
    ...
    doc.autoTable({
      ...
      bodyStyles: {
        fillColor: (row, data) => (row.index % 2 === 0 ? "#f8f9fa" : "#ffffff"),
      },
