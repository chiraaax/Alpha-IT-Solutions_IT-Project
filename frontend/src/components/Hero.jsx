    ...
    >
      ...
      {sidebarItems.map((item, index) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-r from-blue-600/0 via-blue-600/10 to-blue-600/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${hoveredItem === index ? 'animate-pulse-slow' : ''}`}></div>
              
              <div className="relative flex items-center justify-between w-full">
                <span className="uppercase text-gray-300 group-hover:text-white transition-all duration-300">
                  {item.label}
                </span>
                <span className="text-blue-400 transform transition-all duration-500 scale-0 group-hover:scale-100">
                  {item.icon}
                </span>
              </div>
...
>
  ...
  <div className="mt-2 text-3xl italic font-bold relative z-10 bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent group-hover:from-blue-100 group-hover:to-white transition-all duration-300">Custom Pre-builds</div>
  <p className="text-gray-300 relative z-10 group-hover:text-blue-100 mt-1">- Build your dream PC -</p>
</Link>
</nav>
</aside>
