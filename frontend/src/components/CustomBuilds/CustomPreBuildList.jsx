...
const BuildCard = React.memo(({ build, isSelected, onCompare }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-xl border border-sky-500/30 backdrop-blur-sm relative overflow-hidden neon-box"
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
    >
      {/* Tech Circuit Pattern Overlay */}
      <div className="absolute inset-0 opacity-10 z-0 bg-[radial-gradient(#3498db_1px,transparent_1px)] bg-[length:16px_16px]"></div>
      
      {/* Glass Reflection Effect */}
      <div className="absolute -inset-full h-56 w-56 z-0 opacity-30 bg-gradient-to-r from-cyan-400 to-sky-500 blur-lg transform rotate-12 -translate-y-16 animate-pulse"></div>
      ...
      <Link to={build.link} aria-label={`View ${build.name}`} className="block relative z-10">
        <div className="relative">
          ...
          <div className="absolute top-4 right-4 bg-cyan-600/90 text-white text-xs px-3 py-1 rounded-full backdrop-blur-sm neon-text">
            {build.id === 1 ? "4K BEAST" : "VALUE KING"}
          </div>
        </div>
      </Link>
      ...
      <div className="text-center relative z-10">
        ...
        <p className="text-gray-300 mb-5">{build.description}</p>
        ...
        <div className="w-full py-2 px-3 bg-gradient-to-r from-gray-800/80 to-gray-900/80 backdrop-blur rounded-lg border border-gray-700 mb-5 neon-box">
          <p className="text-cyan-400 font-mono">{build.price}</p>
        </div>
      </div>
...
const SpecBar = ({ label, value, maxValue, color }) => (
  <div className="mb-3">
    <div className="flex justify-between mb-1">
      <span className="text-xs font-medium text-cyan-300 neon-text">{label}</span>
      <span className="text-xs font-medium text-cyan-100 neon-text">{value}</span>
    </div>
    <div className="w-full bg-gray-700 rounded-full h-2 relative overflow-hidden neon-box">
      <div 
...
const ComparisonCard = ({ build }) => {
  const cpuScore = build.id === 1 ? 85 : 65;
  const gpuScore = build.id === 1 ? 90 : 70;
  const ramScore = build.id === 1 ? 95 : 75;
  ...
  return (
    <motion.div 
      ...
      className="p-6 border border-cyan-500/30 rounded-lg bg-gradient-to-b from-gray-900 to-gray-800 backdrop-blur-sm relative overflow-hidden neon-box"
    >
      {/* Tech Circuit Pattern */}
      <div className="absolute inset-0 opacity-5 z-0 bg-[radial-gradient(#3498db_1px,transparent_1px)] bg-[length:12px_12px]"></div>
      ...
      <div className="relative z-10">
        <h2 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-sky-500 text-center mb-6 neon-text">
          {build.name}
        </h2>
        ...
        <div className="space-y-6 text-gray-200">
          ...
          <div className="bg-gray-800/70 rounded-lg p-4 border border-gray-700 neon-box">
            <h3 className="text-md font-semibold text-cyan-300 mb-4 neon-text">Performance Metrics</h3>
          ...
          {/* Core Specs */}
          <div className="bg-gray-800/70 rounded-lg p-4 border border-gray-700 neon-box">
            <h3 className="text-md font-semibold text-cyan-300 mb-3 neon-text">Core Components</h3>
            
            <div className="space-y-3">
              {/* CPU */}
              <div className="flex items-center">
                <div className="w-8 h-8 bg-blue-900/50 rounded-full flex items-center justify-center mr-3 border border-blue-500/30 neon-box">
                ...
                <div>
                  ...
                  <p className="text-sm font-mono">{build.cpu}</p>
                </div>
              </div>
              
              {/* GPU */}
              <div className="flex items-center">
                <div className="w-8 h-8 bg-green-900/50 rounded-full flex items-center justify-center mr-3 border border-green-500/30 neon-box">
                ...
                <div>
                  ...
                  <p className="text-sm font-mono">{build.gpu}</p>
                </div>
              </div>
              
              {/* RAM */}
              <div className="flex items-center">
                <div className="w-8 h-8 bg-purple-900/50 rounded-full flex items-center justify-center mr-3 border border-purple-500/30 neon-box">
                ...
                <div>
                  ...
                  <p className="text-sm font-mono">{build.ram}</p>
                </div>
              </div>
              
              {/* Storage */}
              <div className="flex items-center">
                <div className="w-8 h-8 bg-amber-900/50 rounded-full flex items-center justify-center mr-3 border border-amber-500/30 neon-box">
                ...
                <div>
                  ...
                  <p className="text-sm font-mono">{build.storage}</p>
                </div>
              </div>

              {/* PSU */}
                  <div className="flex items-center">
                <div className="w-8 h-8 bg-red-900/50 rounded-full flex items-center justify-center mr-3 border border-red-500/30 neon-box">
                ...
                <div>
                  ...
                  <p className="text-sm font-mono">{build.energyEfficiency}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Performance Stats */}
          <div className="bg-gray-800/70 rounded-lg p-4 border border-gray-700 neon-box">
            <h3 className="text-md font-semibold text-cyan-300 mb-3 neon-text">Gaming Performance</h3>
            <div className="font-mono text-sm text-cyan-100 bg-gray-900/80 p-3 rounded border border-cyan-900/50 neon-box">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-emerald-900/20 rounded-lg p-3 border border-emerald-500/30 neon-box">
              <h3 className="text-sm font-semibold text-emerald-400 mb-2 flex items-center neon-text">
              ...
              <ul className="space-y-1">
                {build.pros.map((pro, i) => (
                  <li key={i} className="text-xs text-emerald-200 flex items-start neon-text">
                    <span className="text-emerald-400 mr-1">+</span> {pro}
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="bg-rose-900/20 rounded-lg p-3 border border-rose-500/30 neon-box">
              <h3 className="text-sm font-semibold text-rose-400 mb-2 flex items-center neon-text">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
              ...
              <ul className="space-y-1">
                {build.cons.map((con, i) => (
                  <li key={i} className="text-xs text-rose-200 flex items-start neon-text">
                    <span className="text-rose-400 mr-1">-</span> {con}
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div className="bg-gray-800/70 rounded-lg p-4 border border-gray-700 neon-box">
            <div className="flex justify-between mb-1">
              <h3 className="text-sm font-semibold text-cyan-300 neon-text">Price-to-Performance</h3>
              <span className="text-xs font-mono text-cyan-100 neon-text">{build.priceToPerformance}%</span>
            </div>
            <div className="w-full h-3 bg-gray-700 rounded-full overflow-hidden neon-box">
              <div
        ...
        >
          ...
          <div className="bg-gradient-to-b from-gray-900 to-gray-800 rounded-xl shadow-2xl p-6 border border-sky-500/20 relative overflow-hidden neon-box">
            ...
            <div className="flex items-center justify-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-blue-400 px-4 neon-text">
