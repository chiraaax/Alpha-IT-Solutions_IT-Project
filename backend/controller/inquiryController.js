...
export const submitInquiry = async (req, res) => {
    upload(req, res, async function (err) {
        ...
        try {
            ...
            res.status(500).json({ message: "Error in adding inquiry", error: error.message });
        }
    });
};
...
export const getUserInquiries = async(req, res) => {
    try{
        ...
        res.status(500).json({message: "Error in getting user's inquiry", error: error.message});
    }
};
