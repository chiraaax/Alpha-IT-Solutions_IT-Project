...
export const submitReview = async (req, res) => {
  try {
      console.log("📝 Submit Review - Body:", req.body);
      ...
      if (!rating || !comment || !reviewTitle || !fullName || !email) {
          console.log("❌ Missing required fields:", { rating, comment, reviewTitle, fullName, email });
      ...
      if (!hasPurchased) {
        console.log("User has not purchased. User ID:", userId);
